        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <h2 class="mt-8 text-2xl/9 font-bold tracking-tight text-gray-900">Sign Up</h2>
                ...
                <div class="mt-10">
                    <div>
                        <form action="/register" method="POST" class="space-y-6">
                            ...
                            <div>
                                <x-webpage.form-label for="name">Name</x-webpage.form-label>
                                <x-webpage.form-input id="name" name="name" type="text" required />
                                <x-webpage.form-error name="name" />
                            </div>
                            <div>
                            ...
                            <div>
                                <x-webpage.form-label>Confirm Password</x-webpage.form-label>
                                <x-webpage.form-input id="password_confirmation" name="password_confirmation" type="password" required />
                                <x-webpage.form-error name="password_confirmation" />
                            </div>
                            ...
                            <div>
                                <x-webpage.form-button>Sign Up</x-webpage.form-button>
                            </div>
                        </form>
                    </div>
                </div>
